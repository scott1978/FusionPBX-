...
sudo -u postgres /usr/pgsql-14/bin/psql -c "ALTER USER fusionpbx WITH PASSWORD '$database_password';"
sudo -u postgres /usr/pgsql-14/bin/psql -c "ALTER USER freeswitch WITH PASSWORD '$database_password';"
...
echo "      Admin Training:          12th-14th November 2019 (3 Day)"
echo "      Advanced Training:       4th-5th December 2019 (2 Day)"
echo "      Continuing Education:    21st November 2019 (1 Day)"
